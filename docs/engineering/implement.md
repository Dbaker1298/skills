...
If the tickets came from [to-tickets](./to-tickets.md), the tracker they live on was configured by [setup-david-baker-skills](./setup-david-baker-skills.md). `code-review` reads the same configuration to find the originating spec at close-out.
