# Verify/Check Mode for `setup-david-baker-skills`

This project will not add a dedicated verify/check mode (or a separate verify skill) for `setup-david-baker-skills`.
...
- #106 on upstream's tracker: Feature request: verify/check mode for setup-matt-pocock-skills
