...
// The changeset release pipeline that used to invoke it is gone (see
// .agents/adr/0003-no-release-pipeline.md), so it is now only reachable by
// hand via `npm run check-plugin-version`.
